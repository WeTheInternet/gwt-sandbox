...
public final class Sprintf {
  ...
  private static final JavaScriptObject sprintf = GWT.isScript() ? initialize() : null;
  ...
  private static native JavaScriptObject initialize()
    /*-{
        ...
        // MODIFICATION: instead of exporting to window / etc, we just return the function we want to apply later
        return vsprintf;
    }-*/;

  public static String format(String format, Object... args) {
    if (GWT.isScript()) {
      return nativeFormat(sprintf, format, args);
    }
    return String.format(format, args);
  }

  public static native String nativeFormat(JavaScriptObject sprintf, String format, Object... args)
  /*-{
